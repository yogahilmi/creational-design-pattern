package com.tasanah.creationaldesignpattern.singleton;
...
class SingletonApplicationTest {
    ...
    @Test
    void testSingleton() {
        var counter1 = applicationContext.getBean(Counter.class);
        var counter2 = applicationContext.getBean(Counter.class);
        var counter3 = applicationContext.getBean(Counter.class);
